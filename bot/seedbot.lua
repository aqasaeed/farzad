...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {146340607,160522435},--Sudo users
    disabled_channels = {},
...
*Only admins and sudo can use res, setowner, commands
    ...
    help_text = [[
لیست دستورات : CommandList
♨️ Telιиυx | تِــلينوكــــس ♨️
_______________________________
kick [یوزرنیم،آیدی،ریپلای] 
شخص مورد نظر از گروه اخراج ميشود.
اين دستور را در ريپلي نيز ميتوانيد استفاده كنيد
_______________________________
ban [آیدی،یوزرنیم،ریپلای]
...
_______________________________
setflood [تعداد]
میزان حساسیت نسبت به پیام های پشت سر هم ارسال شده توسط فرد
_______________________________
set [متن] [كلمه]
...
پاکسازی مدیرها/قوانین/درباره گروه
_______________________________
info [ریپلای]
...
log : اطلاعات گروه
_______________________________
invite [یوزرنیم، آی دی] : 
دعوت افراد به گروه
_______________________________
stats : آمار در پیام ساده
_______________________________
who : لیست اعضاي گروه شما
_______________________________
@TeliNuxx 
_______________________________

plugins enable 'plugin' chat
فعال کردن يكي ابزار در گروه
_______________________________
plugins disable 'plugin' chat
غیر فعال کردن يكي از ابزار در گروه

_______________________________
براي اجراي دستورات از "!" و "/" استفاده نماييد]]
  }
